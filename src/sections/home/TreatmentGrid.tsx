        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((feat, idx) => (
            <ScrollReveal key={idx} delay={idx * 150} className="h-full">
              <div className="group p-8 rounded-3xl bg-cream border border-border-light hover:border-accent/30 hover:shadow-xl hover:shadow-accent/5 hover:-translate-y-1 transition-all duration-400 cursor-default h-full flex flex-col">
                <div className="w-14 h-14 bg-surface-pink rounded-2xl flex items-center justify-center mb-6 text-accent group-hover:bg-accent group-hover:text-white transition-all duration-300 shrink-0">
                  {feat.icon}
                </div>
